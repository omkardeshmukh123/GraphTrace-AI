...
║    graph_writer.py — M3 plugin write_graph(): writes ArtifactGraph ║
...
║                                                                   ║
║  Integration with M3:                                            ║
║    backend/knowledge_graph/graph_writer.py implements the M3      ║
║    graph_writer plugin using this module's Neo4j connection.         ║
╚══════════════════════════════════════════════════════════════════╝
"""
...
__all__ = ["KnowledgeGraphBuilder", "GraphQueryEngine", "get_driver", "close_driver", "write_graph"]
